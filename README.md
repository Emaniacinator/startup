...
- [x] **Bundled using Vite** - The application now correctly uses vite
- [x] **Components** - All of the components have been properly converted to use react
- [x] **Router** - All of the application information now passes through a router
...
- [x] **Stores data in MongoDB** - The data is now stored and persistent in MongoDB
- [x] **Stores credentials in MongoDB** - Users and their credentials are also now stored and persistent in MongoDB
