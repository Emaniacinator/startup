...
async function getUserInformation(elementToGet, valueToSearchFor) {
  if (!elementToGet){
    return null;
  };

  return temporaryUserInfoStorage.find((currentItem) => currentItem[elementToGet] === valueToSearchFor);
};
